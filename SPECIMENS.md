...
Measured 2026-09-13 21:01 UTC on wasmer/edgejs@0.2.0, `--experimental-napi`, default-deny network.
...
| `@stripe/mcp` | 0.3.3 | no | - | 0.3s | Error: getaddrinfo ENOTFOUND mcp.stripe.com | code: 'ENOTFOUND', — third-party, Stripe; a stdio proxy to mcp.stripe.com |
